...
int esPalindromo(char* palabra) { //metodo que me dice si la palabra que se pasa como parametro es palindroma o no
	int i, j;
...
int main(int argc, char* argv[])
{
	...
	//Bucle para hacerlo concurrente concurrente
	for (;;) {
		printf("Escuchando\n");
